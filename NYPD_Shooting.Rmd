...
This is an R Markdown document for the Analysis of NYC Shooting Incident data. The shooting incident data was downloaded from https://data.cityofnewyork.us 
...
Download data from https://data.cityofnewyork.us/api/views/833y-fsy8/rows.csv?accessType=DOWNLOAD and assign this url to *url_in* variable.  Read the data to *raw_data* variable using function *read_csv(url_in)*.
